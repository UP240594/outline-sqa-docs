...
% ==================== 2.1 DESCRIPCIÓN DEL PROYECTO (trabajo de todos - redactado por Olivia) ====================
...
Plan de Aseguramiento de la Calidad del Software conforme al estándar IEEE 730-2014 \cite{ieee730} para el proyecto Outline. Establece actividades, responsabilidades y métricas para garantizar el cumplimiento de requisitos funcionales y no funcionales.

\subsection{§3 Management (Roles y responsabilidades)}
\begin{table}[H]
\centering
\caption{Roles y responsabilidades en el plan SQA}
\begin{tabular}{|l|p{8cm}|}
\hline
\textbf{Rol} & \textbf{Responsabilidades} \\ \hline
Gerente de Proyecto & Aprobar el plan SQA, asignar recursos, supervisar hitos de calidad. \\ \hline
Líder de Calidad (SQA) & Ejecutar auditorías internas, medir KPIs, reportar no conformidades. \\ \hline
Desarrolladores & Seguir estándares de codificación, realizar pruebas unitarias. \\ \hline
Analista de Pruebas & Diseñar y ejecutar casos de prueba, reportar incidentes. \\ \hline
Cliente / Usuario clave & Validar criterios de aceptación, reportar problemas. \\ \hline
\end{tabular}
\end{table}
...
\paragraph{Chairez Alba Olivia Lizbeth (UP240594) -  y Developer:}
Redacté la portada, introducción, descripción del proyecto (sección 2.1) y conclusión. Unifiqué y armonicé todas las partes de mis compañeros en un solo documento LaTeX, corregí errores de compilación y formateé el documento final. Gestioné el repositorio Git y aseguré la consistencia general.
...
Redacté la sección 2.4 (Plan SQA según IEEE 730), incluyendo propósito, gestión, estándares, estrategia de pruebas y SLA por severidad. Adapté el estándar al contexto del equipo.
